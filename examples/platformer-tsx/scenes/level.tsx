...
export abstract class Level extends Scene {
	...
	override onReady() {
		...
		// The contact normal points into the player. When normal.y < 0 the
		// player is above the enemy (landed on top) → stomp. Otherwise the
		// enemy touched the player from the side or below → take 1 damage.
