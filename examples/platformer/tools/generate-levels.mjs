...
/**
 * Fill background layer: empty everywhere (canvas background color shows through).
 * Previously used BG tile (solid brown block) for air, but that looked wrong.
 */
function backgroundLayer(_solid, width, height) {
 ...
 *   E = level exit (on air)
 *   ^ = spike hazard (on air, placed on ground surface)
