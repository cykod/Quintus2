	...
	override build() {
		return (
			<>
				...
				<StaticCollider collisionGroup="walls" position={[200, 200]}>
					<CollisionShape shape={Shape.rect(60, 16)} />
				</StaticCollider>
				<StaticCollider collisionGroup="walls" position={[600, 200]}>
					<CollisionShape shape={Shape.rect(60, 16)} />
				</StaticCollider>
				<StaticCollider collisionGroup="walls" position={[400, 300]}>
					<CollisionShape shape={Shape.rect(16, 60)} />
				</StaticCollider>
				<StaticCollider collisionGroup="walls" position={[200, 430]}>
					<CollisionShape shape={Shape.rect(60, 16)} />
				</StaticCollider>
				<StaticCollider collisionGroup="walls" position={[600, 430]}>
					<CollisionShape shape={Shape.rect(60, 16)} />
				</StaticCollider>
			</>
		);
