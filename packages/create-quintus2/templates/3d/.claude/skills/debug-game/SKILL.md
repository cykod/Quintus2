...
allowed-tools: Bash(pnpm qdbg:*),Bash(npm run qdbg:*),Bash(./bin/qdbg:*),Bash(playwright-cli:*)
---
...
```bash
# 1. Connect to your running game (reads .qdbg.json, starts dev server if needed)
pnpm qdbg connect
